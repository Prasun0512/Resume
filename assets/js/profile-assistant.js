  ...
  function initAssistant() {
    ...
    function openAssistant() {
      ...
      if (!messages.dataset.started) {
        messages.appendChild(createMessage("bot", "<p><strong>Hi, I am Prasun's portfolio assistant.</strong> Ask about AI/ML experience, projects, skills, or paste a JD for a fit check. Instant mode is always available; optional LLM mode runs only when the browser supports it.</p>"));
